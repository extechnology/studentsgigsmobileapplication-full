    ...
    if (state is LoginIoading) {
      return  Column(crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          ...
          Center(child: textform(hint: "Name",iconforsuffix: Icon(Icons.keyboard_arrow_right),controllers: username, context: context)),
                ...
                child: Align(
                  ...
                  child: TextFormField(
                    ...
                    decoration: InputDecoration(
                      ...
                      contentPadding: EdgeInsets.symmetric(vertical:height * 0.025, horizontal: width * 0.033),
                      suffixIcon: Padding(
                        padding: EdgeInsets.only(right: width * 0.022), // 👈 Adjust padding here
                        child: IconButton(
                          icon: Icon(
            ...
            child: Material(
              ...
              child: InkWell(
                ...
                child: Container(
                    width: width * 0.85,
                    height: height * 0.0753,
                    padding: EdgeInsets.symmetric(horizontal: width * 0.056, vertical: height * 0.025),
                    decoration: BoxDecoration(
          ...
          Center(
            child: InkWell(
              onTap: () {
                final parentContext = context; // 👈 Save the outer context
                      ...
                      actions: [
                        ...
                        ElevatedButton(
                          onPressed: () {
                            ...
                            parentContext.read<ResetpasswordCubit>().resetPassword(
                              email: emailController.text.trim(),
                            );
                            Navigator.pop(context); // Optionally close dialog after action
                          },
                          child: Text('OK'),
                        ),
                      ],
...
Widget textform({ required BuildContext context ,TextEditingController ? controllers,String ? hint, Icon ?  iconforsuffix}){
  final width = MediaQuery.of(context).size.width;
  final height = MediaQuery.of(context).size.height;
  return
    Material(
        ...
        child:  Align(
          ...
          child: TextFormField(
            ...
            decoration: InputDecoration(
              ...
              hintText: hint,
              suffixIcon: Padding(
                  padding: EdgeInsets.only(right: width * 0.033), // 👈 Adjust padding here
                  child: iconforsuffix
              ),
              contentPadding: EdgeInsets.symmetric(vertical: height * 0.025, horizontal: width * 0.039),
