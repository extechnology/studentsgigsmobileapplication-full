      ...
      body: BlocProvider(
        ...
        child: BlocBuilder<PlanusageCubit, PlanusageState>(
          builder: (context, state) {
            final cubit = context.read<PlanusageCubit>();
            ...
            if (state is PlanusageIoading) {
              ...
              final created =
                  DateFormat('dd MMM yyyy').format(plan.planCreatedDate);
              final expiry =
                  DateFormat('dd MMM yyyy').format(plan.planExpiryDate);
              final days =
                  plan.planExpiryDate.difference(plan.planCreatedDate).inDays;
              final remaining =
                  plan.planExpiryDate.difference(DateTime.now()).inDays;
                        ...
                        Padding(
                          ...
                          child: Text(
                            ...
                            style: TextStyle(
                              ...
                              fontSize: 19,
                              height: 32 /
                                  20, // Flutter's height is a multiple of font size
                              letterSpacing: 0,
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            border: Border.all(
                              ...
                              width: width *
                                  0.002, // 👈 Responsive border width (~0.8px on 400px screen)
                            ),
                          ),
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                    color: Color(
                                        0xffEB8125), // 5% orange background
                                    borderRadius: BorderRadius.circular(16),
                                    boxShadow: [
                                      BoxShadow(
                                        color: Color(
                                            0x40000000), // 25% black = hex 40 alpha
                                        offset: Offset(0, 4),
                                        blurRadius: 4,
                                        spreadRadius:
                                            0, // softer downward shadow
                                      ),
                                    ],
                                  ),
                                  child: Row(
                                    ...
                                    Material(
                                      ...
                                      child: Container(
                                        ...
                                        decoration: BoxDecoration(
                                          ...
                                          border: Border.all(
                                            color: Color(
                                                0xFF0C792F), // border color: #0C792F
                                            width:
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            Icon(
                                              Icons.access_time,
                                              color: Color(0xff479F51),
                                            ),
                                            SizedBox(
                                                width: width * 0.01), // gap
                                            Container(
                                              width: width * 0.24,
                                              child: Text(
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    // ),
                                    Text(
                                      "${plan.planFeatures[0].used}of ${plan.planFeatures[0].limit} used",
                                      style:
                                          TextStyle(color: Color(0xffEB4335)),
                                ...
                                buildcontaner(
                                    text: 'Profile Access Used',
                                    icons: Icon(
                                      Icons.bolt,
                                      color: Color(0xffEB8125),
                                    ),
                                    textnun:
                                        plan.planFeatures[0].used.toString(),
                                    context: context),
                                SizedBox(
                                  height: height * 0.01,
                                ),
                                buildcontaner(
                                    text: 'Profile Access Left',
                                    icons: Icon(
                                      Icons.add,
                                      color: Color(0xffEB8125),
                                    ),
                                    textnun: " ${profileaccess}",
                                    context: context),
                                SizedBox(
                                  height: height * 0.01,
                                ),
                                buildcontaner(
                                    ...
                                    textnun:
                                        " ${formatPercent(profileaccessPercent)}",
                                    context: context),
                                SizedBox(
                                  height: height * 0.02,
                                ),
                                ...
                                Row(
                                  children: [
                                    ...
                                    Text(
                                      "${plan.planFeatures[1].used}of ${plan.planFeatures[1].limit} used",
                                      style:
                                          TextStyle(color: Color(0xffEB4335)),
                                    )
                                  ],
                                ...
                                buildcontaner(
                                    text: 'Job Posting Used',
                                    icons: Icon(
                                      Icons.bolt,
                                      color: Color(0xffEB8125),
                                    ),
                                    textnun: "${plan.planFeatures[1].used}",
                                    context: context),
                                SizedBox(
                                  height: height * 0.01,
                                ),
                                buildcontaner(
                                    text: 'Job Posting Left',
                                    icons: Icon(
                                      Icons.add,
                                      color: Color(0xffEB8125),
                                    ),
                                    textnun: "${profileaccess2}",
                                    context: context),
                                SizedBox(
                                  height: height * 0.01,
                                ),
                                buildcontaner(
                                    ...
                                    textnun:
                                        "${formatPercent(profileaccess2Percent)}",
                                    context: context),
                                SizedBox(
                                  height: height * 0.02,
                                ),
...
Widget buildbox(
    {required String text, required Color color, double? fontsize}) {
  return Text(
    text,
    style: TextStyle(
      fontFamily: 'Sora',
            ...
            children: [
              ...
              Text(
                ...
                style: TextStyle(
                  ...
                  fontSize: 15,
                  height:
                      32 / 15, // line height of 32px for 15px font size ≈ 2.13
                  letterSpacing: 0,
