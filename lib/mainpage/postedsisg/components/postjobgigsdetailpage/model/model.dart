...
List<Postedpagelist> postedpagelistFromJson(String str) =>
    List<Postedpagelist>.from(
        json.decode(str).map((x) => Postedpagelist.fromJson(x)));
...
class Employee {
        ...
        preferredJobCategories: (json["preferred_job_categories"] is List)
            ? (json["preferred_job_categories"] as List)
                .map((e) => e is Map<String, dynamic>
                    ? PreferredJobCategory.fromJson(e)
                    : null)
  ...
  Map<String, dynamic> toJson() => {
        ...
        "work_preferences":
            List<dynamic>.from(workPreferences.map((x) => x.toJson())),
