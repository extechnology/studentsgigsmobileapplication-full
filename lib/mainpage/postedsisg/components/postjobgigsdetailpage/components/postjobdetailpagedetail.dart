      ...
      body: SafeArea(
        child: Padding(
          ...
          child: SingleChildScrollView(
            child: Padding(
              padding:  EdgeInsets.only(left: width * 0.03,bottom: height* 0.040,top: height* 0.025),
              child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  ...
                  Row(
                    children: [
                      Icon(Icons.insert_drive_file_outlined,color: Color(0xffEB8125),size: width * 0.06,),
                      SizedBox(width: width*0.015,),
                      buildFieldTitle(title: "Application Details ", width: width),
                    ],
                  ),
                  SizedBox(height: height * 0.03,),
                          ...
                          children: [
                            ...
                            Material(
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  border: Border.all(
                                    color: Colors.yellow, // 🔶 Your border color
                                ...
                                CircleAvatar(
                                  ...
                                  onBackgroundImageError: (_, __) {
                                    debugPrint('Failed to load image, falling back.');
                                  },
                                ),
                            ...
                            Center(
                              child: Container(
                                ...
                                child: Center(
                                  child: Padding(
                                    padding: EdgeInsets.only(left: width * 0.07,right: width * 0.07), // ~27.0 when width ≈ 390
                                    child: Text("${detailsof.employee.jobTitle}",
                              ...
                              itemBuilder: (context, index) {
                                ...
                                return Container(
                                  padding: EdgeInsets.symmetric(
                                    vertical: height * 0.01,   // ~8px on 800px screen height
                                    horizontal: width * 0.09,  // ~16px on 400px screen width
                                  ), child: Material(
                                  elevation: 2,
                                  ...
                                  child: Container(
                                    padding: EdgeInsets.symmetric(
                                      horizontal: width * 0.0426, // ≈ 16 on 375px width
                                      vertical: height * 0.0098,  // ≈ 8 on 812px height
                                    ),                                  decoration: BoxDecoration(
                                        color: Color(0xFFD9E9FF), // Light blue background
                                        borderRadius: BorderRadius.circular(30), // Pill shape
                                      ),
                                      child: Center(
                                        child: Text(
                                          ...
                                          style: TextStyle(
                                            ...
                                            fontFamily: 'Sora', // Optional: match your app font
                                          ),
                                        ),
                                      ),
                                    ),
                                  ...
                                  child: Padding(
                                    ...
                                    child:Column(
                                        children: [
                                          ...
                                          rebuildof(icona: Icons.mail_outline,texta: "Email",textb: "${detailsof.employee.email}", context: context),
                                          SizedBox(height: height* 0.02,),

                                          rebuildof(icona: Icons.phone_outlined,texta: "Phone",textb: "${detailsof.employee.phone}", context: context),
                                          SizedBox(height: height* 0.02,),

                                          rebuildof(icona: Icons.location_on_outlined,texta: "Location",textb: detailsof.employee.preferredWorkLocation, context: context),
                                          SizedBox(height: height* 0.02,),

                                          rebuildof2(icona: Icons.code_sharp,texta: "Portfolio Link",textb: "${detailsof.employee.portfolio}", context: context),
                                          SizedBox(height: height* 0.02,),
            ...
            InkWell(
              onTap: () async {
                if (textb != null && await canLaunchUrl(Uri.parse(textb))) {
                  await launchUrl(Uri.parse(textb), mode: LaunchMode.externalApplication);
                } else {
