...
class Homepagedetailpage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: BlocProvider(
        create: (context) => HomepagedetailCubit()..fetchEmployeeDetail(id: id),
        child: BlocBuilder<HomepagedetailCubit, HomepagedetailState>(
          builder: (context, state) {
            if (state is HomepagedetailLoding) {
              ...
              final imageUrl = coverPhoto ?? "https://via.placeholder.com/150";
              final profileImage =
                ...
                body: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      SizedBox(
                        height:
                            imageUrl.isNotEmpty ? height * 0.3 : height * 0.1,
                        child: Stack(
                          children: [
                            ClipRRect(
                            ...
                            Align(
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  border: Border.all(
                                    color: Color(
                                        0xffFFFFFF), // 🟡 Changed to yellow border
                                    width: height * 0.0055,
                                  ),
                                  color: Colors
                        ...
                        child: Container(
                          ...
                          child: Text(
                            ...
                            style: TextStyle(
                              ...
                              fontSize: 16,
                              height: 23 /
                                  16, // Line-height in px ÷ font-size = 1.4375
                        ...
                        child: Padding(
                          ...
                          child: Container(
                            padding: EdgeInsets.symmetric(
                              horizontal:
                                  width * 0.04, // responsive horizontal padding
                              vertical:
                                  height * 0.01, // responsive vertical padding
                            ),
                            decoration: BoxDecoration(
                              color: Color(0xffDAD9E3).withOpacity(
                                  0.3), // Light grey-purple background (you can tweak)
                              borderRadius: BorderRadius.circular(
                                  4), // Optional: slight rounding
                            ),
                            child: Text(
                              '${data.jobTitle}',
                              textAlign: TextAlign.center,
                              style: TextStyle(
                                color: Color(
                                    0xffD50054), // Strong pink/magenta tone
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            buildes2(
                                text: data.about ?? 'N/A', context: context),
                            SizedBox(
                                height:
                                    height * 0.015), // 1.5% of screen height
                            Row(
                              children: [
                                buildes(
                                    text: "Personal Details", context: context),
                                SizedBox(
                                    width: width *
                                        0.012), // For example, ~5px if screen width is ~400
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  borderRadius: BorderRadius.circular(height *
                                      0.021), // Example: ~17 on 800px height
                                ),
                                child: Padding(
                                  padding: EdgeInsets.symmetric(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      builde3(
                                          ...
                                          context: context),
                                      builde4(
                                          text: "${data.availableWorkHours}",
                                          context: context),
                                      builde3(
                                          text: "Preferred Location",
                                          context: context),
                                      builde4(
                                          text: data.preferredWorkLocation ??
                                              'N/A',
                                          context: context),
                                      builde3(
                                          text: "Language Known",
                                          context: context),
                                      builde4(
                                        text: data.languages.isNotEmpty
                                            ? data.languages
                                                .map((e) => e.language ?? '')
                                                .where(
                                      ...
                                      Center(
                                        child: ElevatedButton.icon(
                                          ...
                                          style: ElevatedButton.styleFrom(
                                            ...
                                            fixedSize: Size(
                                              width *
                                                  0.55, // approx 55% of screen width
                                              height *
                                                  0.05, // approx 5% of screen height
                                            ),
                                          ),
                                        ),
                                      ),
                            ...
                            Row(
                              children: [
                                buildes(
                                    text: "Technical Skills", context: context),
                                SizedBox(
                                    width: width *
                                        0.0125), // 5 if screen width ≈ 400
                            ...
                            GridView.builder(
                              ...
                              gridDelegate:
                                ...
                                crossAxisCount: 2,
                                mainAxisSpacing:
                                    height * 0.02, // e.g., 2% of screen height
                                crossAxisSpacing:
                                    width * 0.04, // e.g., 4% of screen width
                                childAspectRatio: width /
                                    (height *
                                        0.20), // or tweak to get similar to 2.8
                              ),
                              itemBuilder: (context, index) {
                                ...
                                return Container(
                                  padding: EdgeInsets.all(
                                      width * 0.03), // or use height * 0.015
                                  decoration: BoxDecoration(
                                    borderRadius: BorderRadius.circular(height *
                                        0.015), // roughly 12 on 800px height
                                  ),
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      SizedBox(
                                          height: height *
                                              0.01), // 0.01 → ~8px on 800px screen height
                                      LinearProgressIndicator(
                                        value: percent,
                                        color: Colors.green,
                                        backgroundColor: Colors.grey[300],
                                        minHeight: height *
                                            0.0075, // ~6px on 800px height
                                        borderRadius: BorderRadius.circular(
                                            height *
                            ...
                            Row(
                              children: [
                                ...
                                SizedBox(
                                    width: width *
                                        0.012), // ≈ 5px if screen width is ~400
                            ...
                            GridView.builder(
                              ...
                              gridDelegate:
                                ...
                                childAspectRatio:
                                    2.5, // Try removing it or increasing the ratio (e.g. 2.5 or 3)
                              ),
                              itemBuilder: (context, index) {
                            ...
                            Row(
                              children: [
                                ...
                                SizedBox(
                                    width: width *
                                        0.012), // Adjust multiplier as needed
                                ...
                                return Card(
                                  ...
                                  child: Container(
                                    ...
                                    decoration: BoxDecoration(
                                      ...
                                      color:
                                          Color(0xffF9F2ED).withOpacity(0.80),
                                    ),
                                    child: Padding(
                                      padding: EdgeInsets.only(
                                          bottom: height * 0.01,
                                                ...
                                                child: Text(
                                                  ...
                                                  style: TextStyle(
                                                    ...
                                                    fontWeight: FontWeight
                                                        .w400, // Regular
                                                    fontSize: width *
                                                        0.032, // Example: 3.2% of screen width
                                                    height:
                                                        1.35, // 135% line height = 15 * 1.35 = ~20.25px
                                                    letterSpacing: 0,
                                                    color: Colors
                                                        .black, // Optional: set color if needed
                                                  ),
                                                  overflow:
                                                  ...
                                                  Container(
                                                    ...
                                                    child: Text(
                                                      ...
                                                      style: TextStyle(
                                                        ...
                                                        height:
                                                            1.35, // 135% line height (11 * 1.35 ≈ 14.85px)
                                                        letterSpacing: 0,
                                                        color: Color(
                                                            0xff004673), // Optional: adjust as needed
                                                      ),
                                                      overflow:
                                                          TextOverflow.ellipsis,
                                                    ),
                                                      ...
                                                      Text(
                                                        ...
                                                        style: TextStyle(
                                                          ...
                                                          fontSize:
                                                              width * 0.021,
                                                          height:
                                                              1.35, // 135% line height (8 * 1.35 = 10.8)
                                                          letterSpacing: 0,
                                                          color: Colors
                                                              .black, // Optional: adjust as needed
                                                        ),
                                                      ),
                                                      Container(
                                                        width: width * 0.26,
                                ...
                                return Card(
                                  ...
                                  child: Container(
                                    ...
                                    decoration: BoxDecoration(
                                      borderRadius: BorderRadius.circular(
                                          height *
                                              0.018), // ~15 when height = 800
                                      color:
                                          Color(0xffF9F2ED).withOpacity(0.45),
                                    ),
                                    child: Padding(
                                      padding: EdgeInsets.only(
                                          bottom: height * 0.01,
                                                    ...
                                                    child: Text(
                                                      ...
                                                      style: TextStyle(
                                                        ...
                                                        fontWeight: FontWeight
                                                            .w700, // Bold
                                                        fontSize: width *
                                                            0.027, // roughly 11 on a 400px width device
                                                        height:
                                                            1.35, // 135% line height (11 * 1.35 ≈ 14.85px)
                                                        letterSpacing: 0,
                                                        color: Color(
                                                ...
                                                child: Text(
                                                  ...
                                                  style: TextStyle(
                                                    ...
                                                    fontWeight: FontWeight
                                                        .w400, // Regular
                                                    fontSize: width *
                                                        0.025, // roughly 10 on a 400px wide device
                                                    height: 1.35,
                                                    letterSpacing: 0,
                                                    color: Colors.black,
                                                  ),
